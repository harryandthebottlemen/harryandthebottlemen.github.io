---
title: My first attempts at publishing using GitGub  Harry Whiting
layout: post
author: harry.whiting
permalink: /my-first-attempts-at-publishing-using-gitgub--harry-whiting/
...
This made me change my ways and I decided to take quick notes (on paper) so that I could remember the instructions in the correct order next time.  This strategy helped me a lot, and the next process went really smoothly.</td>
  ...
  <tr>
    <td>Always be ready to make notes so that I don’t forget, and I can work better independently when things go a bit wrong. Also listen to all instructions</td>
  </tr>
</table>
